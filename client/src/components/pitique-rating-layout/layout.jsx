...
const PitiqueRatingLayout = () => {
  return (
    <div className="w-full h-screen flex justify-center items-center backdrop-blur-[1px] layout fixed">
      <div className="w-[350px] border border-gray-300 rounded-md flex flex-col gap-2 items-center">
        ...
        <h1 className="font-bold">Tyler Boudelarier</h1>
        ...
        <div className="w-full layout p-3">
          <p className="text-gray-600 font-semibold">Leave a comment</p>
        </div>
        <div className="w-full p-3 flex justify-center">
          <textarea
            rows={10}
            className="bg-gray-200 w-[95%] rounded-md"
          ></textarea>
        </div>
...
export default PitiqueRatingLayout;
