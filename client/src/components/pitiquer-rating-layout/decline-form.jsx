const DeclineForm = ({ handleDecline, setDecline, decline }) => {
  return (
    <div className="w-full h-screen flex justify-center items-center backdrop-blur-[1px] fixed top-0 bg-gray-300 bg-opacity-90 left-0">
      <div className="w-[350px] border border-white bg-white p-2 rounded-md flex flex-col gap-2 items-center">
        <div className="w-full  px-3">
          <p className="text-gray-600 font-semibold">Reason for Declining:</p>
        </div>
        <div className="w-full flex justify-center">
          <textarea
            ...
            name="reason"
            value={decline.description}
            onChange={(e) =>
              setDecline({ show: true, description: e.target.value })
            }
          ></textarea>
        </div>
        <div className="w-full flex justify-center">
